  ...
  return __awaiter(this, void 0, void 0, function* () {
    ...
    try {
      ...
      try {
        ...
        try {
          if (!_f && !_a && (_b = fileStream_1.return))
      ...
      const rawOutput =
        ((_e =
          (_d = response.choices[0]) === null || _d === void 0
            ? void 0
...
function rearrangementQuestion(criticalQuestions, level) {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    try {
      const response = yield openai.chat.completions.create({
        model: "gpt-4o",
        messages: prompts_1.default.rearrangementQuestionPrompt.messages.map(
          (msg) => ({
            role: msg.role,
            content: msg.content
      ...
      const result = Object.assign(
        {},
        templates_1.rearrangementQuestionTemplate,
      );
      try {
        const parsedOutput = JSON.parse(rawOutput);
  ...
  return __awaiter(this, void 0, void 0, function* () {
    ...
    try {
      const response = yield openai.chat.completions.create({
        model: "gpt-4o",
        messages:
          prompts_1.default.keywordTranslationQuestionPrompt.messages.map(
            (msg) => ({
              role: msg.role,
              content: msg.content
      ...
      try {
        ...
        result.translatedWords = (0, helper_1.shuffleArray)(
          parsedOutput.translatedWords || [],
        );
      } catch (err) {
        console.error("Failed to parse JSON response:", err);
      }
...
function fillInTheBlankQuestion(criticalQuestions, languageLevel, amount) {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    try {
      const response = yield openai.chat.completions.create({
        model: "gpt-4o",
        messages: prompts_1.default.fillInBlankQuestionPrompt.messages.map(
          (msg) => ({
            role: msg.role,
            content: msg.content
              ...
              .replace(
                "{critical_questions}",
                JSON.stringify(criticalQuestions),
              )
              .replace("{amount}", amount.toString())
...
function multipleChoiceQuestion(criticalQuestions, level) {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    try {
      const response = yield openai.chat.completions.create({
        model: "gpt-4o",
        messages: prompts_1.default.multipleChoiceQuestionPrompt.messages.map(
          (msg) => ({
            role: msg.role,
            content: msg.content
              .replace("{critical_questions}", criticalQuestions.join(", "))
      ...
      const result = Object.assign(
        {},
        templates_1.multipleChoiceQuestionTemplate,
      );
      try {
        const parsedOutput = JSON.parse(rawOutput);
        result.question = parsedOutput.question || "";
