...
function transcribeClass(fileId) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const fileStream = yield (0, storage_1.getFileFromStorage)(fileId, "class_recordings");
        if (!fileStream)
        ...
        try {
            ...
            const uploadedFileUrl = yield (0, storage_1.uploadFileToStorage)(fileId, "transcriptions", transcriptionBuffer, "text/plain");
